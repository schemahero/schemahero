...
func NewForConfigAndClient(c *rest.Config, httpClient *http.Client) (*Clientset, error) {
	...
	var cs Clientset
	var err error
	cs.databasesV1alpha4, err = databasesv1alpha4.NewForConfigAndClient(&configShallowCopy, httpClient)
	if err != nil {
		return nil, err
	}
	cs.schemasV1alpha4, err = schemasv1alpha4.NewForConfigAndClient(&configShallowCopy, httpClient)
	if err != nil {
		return nil, err
	}

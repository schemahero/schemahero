...
DRIVER := timescale
TIMESCALE_PASSWORD_URI := %21%40%23%24%25%5E%26%2A%28%29%7B%7D%27%22%3B
URI := postgres://schemahero:$(TIMESCALE_PASSWORD_URI)@127.0.0.1:15432/schemahero?sslmode=disable

.PHONY: run
run:
	# Fixtures
	docker pull timescale/timescaledb:$(TIMESCALE_VERSION)

...
// SchemasV1alpha1Client is used to interact with features provided by the schemas.schemahero.io group.
type SchemasV1alpha1Client struct {
	restClient rest.Interface
}

func (c *SchemasV1alpha1Client) Migrations(namespace string) MigrationInterface {
	return newMigrations(c, namespace)
}

func (c *SchemasV1alpha1Client) Tables(namespace string) TableInterface {

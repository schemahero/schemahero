...
func (c *FakeDataTypes) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha4.DataType, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(datatypesResource, c.ns, name), &v1alpha4.DataType{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha4.DataType), err
}
...
func (c *FakeDataTypes) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha4.DataTypeList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(datatypesResource, datatypesKind, c.ns, opts), &v1alpha4.DataTypeList{})
	...
	list := &v1alpha4.DataTypeList{ListMeta: obj.(*v1alpha4.DataTypeList).ListMeta}
	for _, item := range obj.(*v1alpha4.DataTypeList).Items {
...
func (c *FakeDataTypes) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(datatypesResource, c.ns, opts))
...
func (c *FakeDataTypes) Create(ctx context.Context, dataType *v1alpha4.DataType, opts v1.CreateOptions) (result *v1alpha4.DataType, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(datatypesResource, c.ns, dataType), &v1alpha4.DataType{})
...
func (c *FakeDataTypes) Update(ctx context.Context, dataType *v1alpha4.DataType, opts v1.UpdateOptions) (result *v1alpha4.DataType, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(datatypesResource, c.ns, dataType), &v1alpha4.DataType{})
...
func (c *FakeDataTypes) UpdateStatus(ctx context.Context, dataType *v1alpha4.DataType, opts v1.UpdateOptions) (*v1alpha4.DataType, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(datatypesResource, "status", c.ns, dataType), &v1alpha4.DataType{})
...
func (c *FakeDataTypes) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(datatypesResource, c.ns, listOpts)

	_, err := c.Fake.Invokes(action, &v1alpha4.DataTypeList{})
	return err
}
...
func (c *FakeDataTypes) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha4.DataType, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(datatypesResource, c.ns, name, pt, data, subresources...), &v1alpha4.DataType{})

	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.SchemasV1alpha4().Tables(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SchemasV1alpha4().Tables(namespace).Watch(context.TODO(), options)
			},
		},
		&schemasv1alpha4.Table{},
		resyncPeriod,
		indexers,
	)
}

func (f *tableInformer) defaultInformer(client schemaheroclientset.Interface, resyncPeriod time.Duration) cache.SharedIndexInformer {
...
func (f *tableInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&schemasv1alpha4.Table{}, f.defaultInformer)
}

func (f *tableInformer) Lister() v1alpha4.TableLister {
	return v1alpha4.NewTableLister(f.Informer().GetIndexer())
}

...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &databasesv1alpha1.Postgres{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
...
// +kubebuilder:rbac:groups=databases.schemahero.io,resources=postgres,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=databases.schemahero.io,resources=postgres/status,verbs=get;update;patch
func (r *ReconcilePostgres) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	// Fetch the Postgres instance
	instance := &databasesv1alpha1.Postgres{}

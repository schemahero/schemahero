...
func (r *ReconcileDatabase) ensureWatchRBAC(instance *databasesv1alpha1.Database) error {
...
func (r *ReconcileDatabase) ensureRoleInNamespaceForInstance(instance *databasesv1alpha1.Database) error {
...
func (r *ReconcileDatabase) ensureRoleBindingInNamespaceForInstance(instance *databasesv1alpha1.Database) error {
	namespacedName := types.NamespacedName{
		Name:      instance.Name,
		Namespace: instance.Namespace,
	}
...
func (r *ReconcileDatabase) ensureServiceAccountInNamespaceForInstance(instance *databasesv1alpha1.Database) error {
	namespacedName := types.NamespacedName{
		Name:      instance.Name,
		Namespace: instance.Namespace,
	}

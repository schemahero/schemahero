...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PostgresqlFunctionParameter) DeepCopyInto(out *PostgresqlFunctionParameter) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PostgresqlFunctionParameter.
func (in *PostgresqlFunctionParameter) DeepCopy() *PostgresqlFunctionParameter {
	if in == nil {
		return nil
	}
	out := new(PostgresqlFunctionParameter)
	in.DeepCopyInto(out)
	return out
}
...
func (in *PostgresqlFunctionSchema) DeepCopyInto(out *PostgresqlFunctionSchema) {
	*out = *in
	if in.Params != nil {
		...
		*out = make([]*PostgresqlFunctionParameter, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(PostgresqlFunctionParameter)

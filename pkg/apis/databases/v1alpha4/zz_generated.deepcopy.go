...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TimescaleConnection) DeepCopyInto(out *TimescaleConnection) {
	*out = *in
	in.PostgresConnection.DeepCopyInto(&out.PostgresConnection)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TimescaleConnection.
func (in *TimescaleConnection) DeepCopy() *TimescaleConnection {
	if in == nil {
		return nil
	}
	out := new(TimescaleConnection)
